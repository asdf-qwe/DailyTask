...
public enum ErrorCode {
    ...
    MEMO_REQUIRED_TITLE(HttpStatus.BAD_REQUEST, "메모 생성시 제목이 누락되었습니다."),
    MEMO_REQUIRED_TEAM(HttpStatus.BAD_REQUEST, "메모 생성시 팀이 누락되었습니다."),
    MEMO_REQUIRED_VISIBILITY(HttpStatus.BAD_REQUEST, "메모 생성시 공개여부가 누락되었습니다."),
